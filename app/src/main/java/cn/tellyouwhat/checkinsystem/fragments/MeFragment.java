...
import cn.tellyouwhat.checkinsystem.activities.ShareActivity;
...
//		Log.i(TAG, "onPause: in MeFragment");
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        checkInGraphicCardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getContext(), "尚未开放，敬请期待", Toast.LENGTH_SHORT).show();
                startActivityForResult(new Intent(getContext(), ShareActivity.class),
                        OPEN_SHARE_ACTIVITY);
            }
        });
